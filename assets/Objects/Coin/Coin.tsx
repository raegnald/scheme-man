...
<tileset version="1.10" tiledversion="1.11.0" name="Coin" class="coin" tilewidth="32" tileheight="32" tilecount="10" columns="0" objectalignment="center" tilerendersize="grid" fillmode="preserve-aspect-fit">
 ...
 <tile id="1">
  <image source="coin02.png" width="32" height="32"/>
 </tile>
 <tile id="2">
  <image source="coin03.png" width="32" height="32"/>
 </tile>
 <tile id="3">
 ...
 <tile id="7">
  <image source="coin08.png" width="32" height="32"/>
 </tile>
 <tile id="8">
  <image source="coin09.png" width="32" height="32"/>
 </tile>
 <tile id="9">
